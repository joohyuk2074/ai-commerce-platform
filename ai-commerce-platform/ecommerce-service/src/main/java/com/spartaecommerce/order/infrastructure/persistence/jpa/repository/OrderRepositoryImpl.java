...
import static com.spartaecommerce.order.infrastructure.persistence.jpa.entity.QOrderItemJpaEntity.orderItemJpaEntity;
import static com.spartaecommerce.order.infrastructure.persistence.jpa.entity.QOrderJpaEntity.orderJpaEntity;
...
public class OrderRepositoryImpl implements OrderRepository {
    ...
    public boolean existsByProductInOrdersWithStatus(Long productId, OrderStatus orderStatus) {
        Integer result = queryFactory
            .selectOne()
            .from(orderJpaEntity)
            .join(orderJpaEntity.orderItems, orderItemJpaEntity)
            .where(
                orderItemJpaEntity.productId.eq(productId),
                orderJpaEntity.status.in(orderStatus)
            )
            .fetchFirst();
