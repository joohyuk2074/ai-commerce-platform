package com.spartaecommerce.cart.infrastructure.storage.redis;
...
public class RedisCartStorage implements CartStorage {
    ...
    public RedisCartStorage(
        ...
        log.info("RedisCartStorage initialized");
    }
