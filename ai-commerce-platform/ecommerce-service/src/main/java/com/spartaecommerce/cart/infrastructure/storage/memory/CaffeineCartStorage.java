package com.spartaecommerce.cart.infrastructure.storage.memory;
...
public class CaffeineCartStorage implements CartStorage {
    ...
    public CaffeineCartStorage() {
        ...
        log.info("CaffeineCartStorage initialized");
    }
