...
public class OrderEvent {
    ...
    public static OrderEvent from(Order order) {
        return OrderEvent.builder()
            ...
            .pointsUsed(order.getUsedPointAmount() != null ? order.getUsedPointAmount().amount() : BigDecimal.ZERO)
            .pointsEarned(order.getEarnedPointAmount() != null ? order.getEarnedPointAmount().amount() : BigDecimal.ZERO)
