...
public class CategoryQueryController {
  ...
  public ResponseEntity<CommonResponse<CategoryProductSalesRankingResponse>> getTopSellingProductsByCategory(
    ...
    List<CategoryProductSalesRankingResult> results = categoryQueryUseCase.getTopSellingProductsByCategory(
        query);
    CategoryProductSalesRankingResponse response = CategoryProductSalesRankingResponse.from(
        results);
